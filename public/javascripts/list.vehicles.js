...
async function onBlock(id) {
    res = await axios.put(window.location.origin + '/vehicle/blocked/' + id)
    onAlert(res);
    renderUnblockBtn(id)
}

async function onUnblock(id) {
    res = await axios.put(window.location.origin + '/vehicle/unlocked/' + id)
    onAlert(res);
    renderBlockBtn(id)
}

async function onDelete(id) {
    res = await axios.delete(window.location.origin + '/vehicle/' + id)
    onAlert(res);
